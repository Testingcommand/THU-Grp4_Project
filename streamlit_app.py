...
# APP CONFIGURATION
# ==========================================
GOOGLE_WEBAPP_URL = "https://script.google.com/macros/s/AKfycby4GV4UUmL1NLOIt7diy7Wr04npyMB5e1EMYcYwIxluegjb1Xqb55Appl0rUNYC6sA/exec"
...
st.markdown("""
    <style>
        ...
        .sticky-scale {
            ...
            z-index: 999;
            padding: 10px 0px;
            border-bottom: 1px solid rgba(128, 132, 149, 0.3);
            margin-bottom: 1rem;
        }
    </style>
...
# ==========================================
@st.cache_data(ttl=5) # Caches for 5 seconds to show toggle instantly
...
if st.session_state.current_step == 'dashboard':
    ...
    # NEW: Citation Line
    st.caption("Adapted from: [The Dimensional Model of Adversity and Psychopathology (DMAP)](https://doi.org/10.1016/j.cpr.2016.10.003)")
...
# --- PART 1: THREAT ---
    ...
    st.markdown(f'<div class="sticky-scale">{t["scale_desc"]}</div>', unsafe_allow_html=True)
